        ...
        <aside className="hero-card reveal" aria-label="Brand and partners">
          ...
          <div className="card-body">
            <div className="brand" style={{ gap: 12 }}>
              <img src="picture/Logo GoldRice.jpg" alt="Logo" />
              <div>
                <div className="name">GoldRice</div>
      ...
      <div className="container">
        ...
        <div className="grid-2">
          ...
          <div className="gallery reveal logo">
            <img src="picture/Logo GoldRice.jpg" alt="GoldRice Logo" loading="lazy" />
          </div>
        </div>
      </div>
    </section>
...
function Products() {
  const items = [
    {
      title: 'ข้าวหอมมะลิออร์แกนิค',
      text: 'หอมนุ่ม เป็นเอกลักษณ์ เหมาะกับทุกมื้อ โดยเฉพาะเมนูไทย',
      icon: '🍚',
    },
    {
      title: 'ข้าวกล้องออร์แกนิค',
      text: 'ไฟเบอร์สูง วิตามินและแร่ธาตุครบถ้วน เทคเจอร์เคี้ยวเพลิน',
      icon: '🌾',
    },
    {
      title: 'ข้าวไรซ์เบอร์รีออร์แกนิค',
      text: 'อุดมสารแอนโธไซยานิน สีม่วงสวย รสชาติเข้มเล็กน้อย',
      icon: '🍽️',
    },
  ]
  return (
    <section id="products" className="section">
      <div className="container">
        <h2 className="reveal">สินค้าแนะนำ</h2>
        <p className="lead reveal">แนะนำสายพันธุ์ยอดนิยมและโพรไฟล์รสชาติ เพื่อช่วยเลือกข้าวที่เหมาะกับคุณ</p>
        <div className="grid-3">
          {items.map((p, i) => (
            <FeatureCard key={i} {...p} />
          ))}
